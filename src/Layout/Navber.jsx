...
const Navber = () => {
  return (
    <div>
      <div className=" bg-[#615DFA] flex items-center px-[24px] py-[15px] justify-between">
        ...
        <div className="">
            <form action="#">
              <input type="text"placeholder="Search here ...." className="w-[415px] h-[50px] pt-[15px] pb-[14px] px-4 bg-[#4E4AC8] rounded-[11px] outline-none focus:bg-white transition duration-700 ease-in-out . " />
            </form>
        </div>
