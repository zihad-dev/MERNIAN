...
const LikeIcon = ({width=20 ,height=20 ,className=""}) => {
  return (
      ...
      >
        ...
        <defs>
          <pattern
            ...
            height="1"
          >
             <use xlinkHref="#image0_1_1351" transform="scale(0.025)" />
          </pattern>
          <image
            id="image0_1_1351"
            width="40"
